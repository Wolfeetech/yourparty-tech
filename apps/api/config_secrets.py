...
# 4. AzuraCast (Radio)
AZURACAST_API_URL = "http://192.168.178.210/api" # Updated to match .env
AZURACAST_API_KEY = "9199dc63da6223190:c9f8c3a22e25932753dd3f4d57fa0d9c" # Corrected from .env
