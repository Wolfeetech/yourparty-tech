...
<section id="references" class="section section--muted">
    <div class="container">
        ...
        <?php else: ?>
            <!-- No Google Reviews configured - show simple CTA -->
            <div style="text-align: center; max-width: 600px; margin: 0 auto; padding: 3rem 2rem; background: var(--bg-card, rgba(20,20,20,0.8)); border-radius: 16px; border: 1px solid var(--border, rgba(255,255,255,0.1));">
                <div style="font-size: 3rem; margin-bottom: 1rem;"></div>
                <h4 style="margin: 0 0 1rem 0; font-size: 1.5rem;">Warst du bei einem Event?</h4>
                <p style="color: var(--text-muted, #888); margin-bottom: 1.5rem;">
                    Dein Feedback hilft anderen, die richtige Entscheidung zu treffen.
                </p>
                <a href="mailto:wolf@yourparty.tech?subject=Feedback%20zum%20Event"
                    style="display: inline-block; padding: 0.875rem 2rem; background: linear-gradient(135deg, var(--emerald, #00ff88), #1a6d41); color: white; border-radius: 24px; text-decoration: none; font-weight: 600; transition: transform 0.2s;">
                    Feedback senden
                </a>
            </div>
        <?php endif; ?>
