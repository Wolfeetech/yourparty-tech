...
function yourparty_register_customizer($wp_customize)
{
    ...
    yourparty_add_text_setting($wp_customize, 'hero_cta_primary', 'Primrer CTA', 'yourparty_hero_content', $defaults);
    yourparty_add_text_setting($wp_customize, 'hero_cta_secondary', 'Sekundrer CTA', 'yourparty_hero_content', $defaults);
    ...
    $wp_customize->add_section(
        ...
        [
            'title' => __('ber uns', 'yourparty-tech'),
            'panel' => 'yourparty_content',
            'priority' => 40,
        ]
    );
    ...
    $wp_customize->add_control(
        ...
        [
            ...
            'description' => __('Z.B. "ChIJN1t_tDeuEmsRUsoyG83frY4" fr Google Places oder "12345678-1234-1234-1234-123456789abc" fr Elfsight', 'yourparty-tech'),
