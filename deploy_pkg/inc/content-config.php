...
function yourparty_content_defaults(): array
{
    return [
        ...
        'hero_lead' => 'High-Fidelity Beschallungslsungen fr anspruchsvolle Club-Installationen, Festivals und private Listening Rooms. Handgefertigt im Bodenseekreis.',
        ...
        'usp_desc_1' => 'Entwicklung und Fertigung von Hochleistungslautsprechern fr elektronische Musik. Fokus auf Phasentreue und Impulsverhalten.',
        'usp_title_2' => 'Stage & Light Design',
        'usp_desc_2' => 'Ganzheitliche Konzepte fr immersive Dancefloors. Wir bauen Bhnenbilder, die den Sound visuell greifbar machen.',
        ...
        'about_lead' => 'Wir sind Ingenieure und DJs mit einer Obsession fr perfekten Klang.',
        'about_text' => 'Was als Leidenschaft fr elektronische Musik begann, ist heute eine Manufaktur fr professionelle Audiotechnik. Wir glauben, dass Musik mehr ist als Schallwellen  sie ist Energie. Unsere Systeme sind darauf ausgelegt, diese Energie verlustfrei auf den Dancefloor zu bringen.',

        // Contact Section
        'contact_eyebrow' => 'Kontakt',
        'contact_title' => 'Start a Project',
        'contact_lead' => 'Planst du einen Club, ein Festival oder suchst du das perfekte System fr dein Studio?',
        ...
        'service_1_desc' => 'Einmessen von PA-Systemen mit modernster Messtechnik (Smaart/Systune) fr linearen Frequenzgang und perfekte Phase.',
        'service_2_title' => 'Installation',
        'service_2_desc' => 'Festinstallation von Ton- und Lichttechnik in Clubs, Bars und Lounges. Kabelfhrung, Rigging und Sicherheit.',
        'service_3_title' => 'Custom Fabrication',
        'service_3_desc' => 'CNC-Fertigung von Lautsprechergehusen, DJ-Booths und akustischen Elementen nach Ma.',
