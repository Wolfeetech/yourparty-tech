    ...
    <div class="container">
        <div class="contact-grid">
            <div class="contact-form">
                ...
                <form action="#" method="post" class="form-grid" id="contact-form">
                    ...
                    <div class="form-field">
                        ...
                        <textarea id="message" name="message" placeholder="Erzhl uns von deinem Event..."
                            required></textarea>
                    </div>
                    ...
                    <p class="form-privacy">
                        Mit dem Absenden stimmst du der <a
                            href="<?php echo esc_url(home_url('/datenschutz')); ?>">Datenschutzerklrung</a> zu.
                    </p>
                </form>
            </div>
            ...
            <div class="contact-details">
                ...
                <div class="contact-card">
                    <h3>Musikwnsche?</h3>
                    <p>Du willst den Sound mitbestimmen? Schick uns deine Wnsche direkt ins Studio.</p>
